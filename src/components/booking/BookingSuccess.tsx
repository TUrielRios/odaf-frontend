  ...
  return (
    <div className="max-w-2xl mx-auto py-10 animate-in fade-in zoom-in duration-700">
      <div className="bg-white rounded-[3rem] shadow-2xl shadow-blue-900/5 p-12 text-center">
        ...
        <h2 className="text-4xl font-black text-[#026498] mb-4">¡Reserva Solicitada!</h2>
        <p className="text-gray-500 font-medium mb-12">
          Tu reserva ha sido recibida con éxito y se encuentra pendiente de aprobación. Te notificaremos una vez confirmada. Podrás ver los detalles en tu panel de usuario.
        </p>
